...
export async function seed_subjects_questions() {
  ...
  const questionBank = {
    'Álgebra Lineal': [
      ...
      { text: '¿Si un sistema de ecuaciones lineales tiene más variables que ecuaciones, entonces siempre tiene infinitas soluciones.?', diff: 'Fácil', type: 'VoF', ans: 'F', score: 2 },
      ...
      { text: '¿Dos vectores son linealmente dependientes si uno es un múltiplo escalar del otro.?', diff: 'Medio', type: 'VoF', ans: 'V', score: 5 },
    ...
    'Física Cuántica': [
      ...
      { text: 'El principio de incertidumbre de Heisenberg establece que es imposible conocer simultáneamente con precisión arbitraria la posición y el momento de una partícula.', diff: 'Medio', type: 'VoF', ans: 'V', score: 5 },
      ...
      { text: 'En la física cuántica, un electrón puede estar en dos estados energéticos diferentes al mismo tiempo debido al fenómeno de superposición.', diff: 'Fácil', type: 'VoF', ans: 'V', score: 5 },
    ...
    'Química Orgánica': [
     ...
     'Biología Celular': [
      ...
      { text: 'La mitocondria es el orgánulo encargado de producir la mayor parte del ATP en las células eucariotas.', diff: 'Fácil', type: 'VoF', ans: 'V', score: 5 },
      ...
      { text: 'Todos los organismos vivos están formados por más de una célula.', diff: 'Fácil', type: 'VoF', ans: 'F', score: 5 },
